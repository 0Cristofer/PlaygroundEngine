...
export module PlaygroundEngine.Reflection:SequenceFacetBuilder;
...
// array T[N]). The specialization lives here, not in the standalone TypeInfoTraits module, because
// MakeFacets names SequenceFacet, a reflection partition that module cannot import; this is the example a
// user follows to add a random-access container of their own.
