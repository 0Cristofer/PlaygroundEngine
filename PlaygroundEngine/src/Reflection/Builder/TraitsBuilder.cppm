...
// is a whole-type scalar read straight off the std::meta::info, with no recursion into members. The
// pre-build generator populates the same struct on platforms without std::meta.
