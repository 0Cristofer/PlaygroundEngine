...
// A deliberately small timing harness: warm up, then time a fixed number of iterations of a
// callable and report nanoseconds per operation. No external benchmark framework is pulled in
// because the global -freflection option leaks onto any FetchContent dependency compiled below
// C++26 and breaks it (see the project notes); a hand-rolled loop sidesteps that fragility and
// is enough to make the reflected-versus-native call overhead visible.
